...
namespace Avand.Latebind {
	static class Cache {
		public class IL {
			...
			internal Constructor _constructor = null;
			internal Dictionary<string, ParamterisedConstructor> _parameterisedConstructors = null;
			internal Dictionary<string, Get> _getProperties = null;
			internal Dictionary<string, Set> _setProperties = null;
			internal Dictionary<string, Method> _methods = null;
			internal Dictionary<string, Get> _staticGetProperties = null;
			internal Dictionary<string, Set> _staticSetProperties = null;
			internal Dictionary<string, Method> _staticMethods = null;

			internal IL( Type t ) { _type = t; }
			...
			internal ParamterisedConstructor GetConstructorInvoker( object [] Params )
			{
				...
				DynamicMethod dynamicMethod = new DynamicMethod( string.Empty, _type, new Type [] { typeof( object ), typeof( object ) }, info.DeclaringType.Module );
				ILGenerator il = dynamicMethod.GetILGenerator();
				...
				ParamterisedConstructor invoker = (ParamterisedConstructor) dynamicMethod.CreateDelegate( typeof( ParamterisedConstructor ) );
	...
	public sealed class Latebound<T> where T : class {
		...
		public object this [ string PropertyName ]
		{
			...
			set
			{
				Cache.SetProperty( typeof( T ), _instance, typeof( T ).GetProperty( PropertyName ), value );
			}
		}

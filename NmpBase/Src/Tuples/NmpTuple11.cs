...
[Serializable]
public class NmpTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> : IStructuralEquatable, IStructuralComparable, IComparable, INmpTuple
{
  // ******
  ...
  public NmpTuple( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, T8 item8, T9 item9, T10 item10, T11 item11 )
  {
    this.m_Item1 = item1;
    this.m_Item2 = item2;
    this.m_Item3 = item3;
    ...
    this.m_Item8 = item8;
    this.m_Item9 = item9;
    this.m_Item10 = item10;
    this.m_Item11 = item11;
  }
  ...
  int IStructuralComparable.CompareTo(object other, IComparer comparer)
  {
    ...
    NmpTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple = other as NmpTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>;
    if (tuple == null) {
    ...
    num = comparer.Compare(this.m_Item8, tuple.m_Item8);
    if (num != 0) {
      return num;
    }
    num = comparer.Compare(this.m_Item9, tuple.m_Item9);
    if (num != 0) {
      return num;
    }
    num = comparer.Compare(this.m_Item10, tuple.m_Item10);
    if (num != 0) {
      return num;
    }

    return comparer.Compare(this.m_Item11, tuple.m_Item11);
  }
  ...
  int IStructuralEquatable.GetHashCode(IEqualityComparer comparer)
  {
    ...
    hc = NmpTuple.CombineHashCodes( hc, NmpTuple.CombineHashCodes( comparer.GetHashCode(this.m_Item8), comparer.GetHashCode(this.m_Item9) ));
    hc = NmpTuple.CombineHashCodes( hc, NmpTuple.CombineHashCodes( comparer.GetHashCode(this.m_Item10), comparer.GetHashCode(this.m_Item11) ));
    return hc;
  }
  ...
  string INmpTuple.ToString(StringBuilder sb)
  {
    ...
    sb.Append(this.m_Item7);  sb.Append(", ");
    sb.Append(this.m_Item8);  sb.Append(", ");
    sb.Append(this.m_Item9);  sb.Append(", ");
    sb.Append(this.m_Item10);  sb.Append(", ");
    sb.Append(this.m_Item11); 
    sb.Append(")");
    return sb.ToString();
  }

...
[Serializable]
public class NmpTuple<T1, T2, T3, T4> : IStructuralEquatable, IStructuralComparable, IComparable, INmpTuple
{
  // ******
  ...
  public NmpTuple( T1 item1, T2 item2, T3 item3, T4 item4 )
  {
    this.m_Item1 = item1;
    this.m_Item2 = item2;
    this.m_Item3 = item3;
  ...
  int IStructuralComparable.CompareTo(object other, IComparer comparer)
  {
    ...
    NmpTuple<T1, T2, T3, T4> tuple = other as NmpTuple<T1, T2, T3, T4>;
    if (tuple == null) {

...
namespace NmpBase {
	...
	[Serializable()] 
	public class NmpStringList : List<string> {

		bool unique = false;

		/////////////////////////////////////////////////////////////////////////////

		public new NmpStringList Add( string s )
		{
		...
		public NmpStringList Add( IEnumerable<string> collection )
		{
			// ******
		...
		public NmpStringList Add( string [] strs )
		{
		...
		public NmpStringList SplitLines( string text, bool trim )
		{
			// ******
		...
		public NmpStringList SplitAndAdd( char splitChar, string str, Func<string, string> action )
		{
		...
		[DebuggerStepThrough]
		public NmpStringList( string text, bool trim )
		{
		...
		[DebuggerStepThrough]
		public NmpStringList( bool unique = false )
		{
			this.unique = unique;
		}
		...
		[DebuggerStepThrough]
		public NmpStringList( char ch, string str, bool unique = false, Func<string, string> action = null )
		{
			this.unique = unique;
		...
		//[DebuggerStepThrough]
		//public NmpStringList( IEnumerable<string> collection, bool unique = false )
		//{
		//	this.unique = unique;
		//	Add( collection );
		//}
		...
		[DebuggerStepThrough]
		public NmpStringList( IEnumerable<object> collection, bool unique = false )
		{
			this.unique = unique;
		...
		[DebuggerStepThrough]
		public NmpStringList( params object [] values )
			:	this( values, false )
		{
		}
